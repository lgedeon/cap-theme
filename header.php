<?php
/**
 * Header template for Carole Ann Penney child theme
 *
 * Displays all of the <head> section and everything up till the navigation inside <div id="main">.
 *
 */
?><!DOCTYPE html>
<!--[if IE 6]>
	...
	<header id="branding" role="banner">
		...
		if ( $header_image ) :
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
				<img src="<?php header_image(); ?>" width="1220" height="386" alt="" />
			</a>
